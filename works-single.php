...
<div id="singlecontent">
		...
		<div class="columns navibg border-color" style="display:none;">
         ...
         <div class="columns navibg withall border-color sisi">
            <div class="four columns alpha">
            	<h3><?php _e('Works','dronetv'); ?></h3>
            </div>
            
            <div class="sixteen columns omega" style="margin-left:0;">
